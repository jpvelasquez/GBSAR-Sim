...
def get_SAR_data():
    ...
    It, Rt, rt_x, rt_y, Nr, Nc = sp.get_matrix_data1() # Coordenadas(m) y magnitud del target respectivamente
    #It, Rt =  sp.get_matrix_data1()
    ...
    dF.plotImage(Sr_f, x_min=fi, x_max=fs, y_min=-Ls/2, y_max=Ls/2,xlabel_name='Frecuencia(GHz)',
                 ylabel_name='Posición del riel(m)', title_name='Histórico de fase',unit_bar='', origin_n='upper',log=True)
